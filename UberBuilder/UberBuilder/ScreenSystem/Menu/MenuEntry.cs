...
//            ///////TEST
//            var test_height = _menu.ScreenManager.GraphicsDevice.Viewport.Height;
//            var test_width = _menu.ScreenManager.GraphicsDevice.Viewport.Width;
//            var test_scale1 = ((float)test_width) / 10f;
//            var test_scale2 = test_scale1 / gameIcon1.Size.X;
//            batch.Draw(
//                gameIcon1.Texture,
//                //new Vector2(((float)test_width) / 2f, ((float)test_height) / 2f), 
//                //Position - _baseOrigin * _scale + Vector2.One,
//                Position - _baseOrigin * _scale,
//                null, 
//                Color.White,
//                0f,
//                gameIcon1.Origin, 
//                Vector2.One/* * (1f / 24f)*/ * test_scale2,
//                SpriteEffects.None,
//                0f);
//            //////////
//        }
