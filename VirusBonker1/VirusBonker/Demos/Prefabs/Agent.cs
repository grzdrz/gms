...
namespace tainicom.Aether.Physics2D.Samples.DemosTEST.Prefabs
{
    public class Agent
    {
        //Body - частичный класс, заполненый методами возвращающими сущности, сцепляющие заданую форму с игровым объектом
        ...
        public void Draw()
        {
            ...
            _batch.Draw(_knob.Texture, _agentBody.Position, null, Color.White, _agentBody.Rotation, _knob.Origin - new Vector2(_offset, 0f) * _knob.Size / new Vector2(2f * 0.5f), new Vector2(2f * 0.5f) * _knob.TexelSize, SpriteEffects.FlipVertically, 0f);
            //test            
            _batch.Draw(_knob.Texture, _agentBody.Position, null, Color.White, _agentBody.Rotation, _knob.Origin + new Vector2(0f, _offset + 2) * _knob.Size / new Vector2(2f * 0.5f), new Vector2(2f * 0.5f) * _knob.TexelSize, SpriteEffects.FlipVertically, 0f);
            //endtest
        }
    }
}