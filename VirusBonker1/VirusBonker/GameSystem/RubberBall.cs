...
namespace tainicom.Aether.Physics2D.Samples.Samples.TEST
{
    public class RubberBall
    {
        ...
        public void Draw()
        {
            _batch.Draw(_circleSprite.Texture, _ball.Position, null, Color.White, _ball.Rotation, _circleSprite.Origin, new Vector2(2f * 1.5f) * _circleSprite.TexelSize, SpriteEffects.FlipVertically, 0f);
        }
    }
}
