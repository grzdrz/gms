...
namespace tainicom.Aether.Physics2D.Samples.ScreenSystem
{
    ...
    public class MainMenuScreen : GameScreen
    {
        ...
        private List<MainMenuEntry> _menuEntries = new List<MainMenuEntry>();
        ...
        {
            MainMenuEntry entry = new MainMenuEntry(this, type, screen);
        ...
        {
            int index = 0;
            foreach (MainMenuEntry entry in _menuEntries)
            {
        ...
        protected virtual void UpdateMenuEntryLocations()
        {
            ...
            for (int i = 0; i < _menuEntries.Count; ++i)
            {
                ...
                else
                {
                    ...
                    position.Y = ScreenManager.GraphicsDevice.Viewport.Height / 2f;
                }
