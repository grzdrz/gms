...
namespace tainicom.Aether.Physics2D.Samples.ScreenSystem
{
    ...
    ///   перечисление всех доступных кнопок мыши.
    /// </summary>
    ...
    {
        //GestureSample - Представление данных из мультитач-жеста за промежуток времени.
        ...
        private Viewport _viewport;//какаято хрень для работы с камерой(?)
