...
namespace UberBuilder.GameSystem.ConstructionMaterials
{
    ...
    public class SegmentableBody
    {
        ...
        public List<Body> _bodiesAfterSegmented = new List<Body>();
        ...
        private SegmentableBody(World world)
        {
            World = world;
        ...
        public SegmentableBody(World world, IEnumerable<Vertices> vertices, float density, Vector2 position = new Vector2(), float rotation = 0) : this(world)
        {
        ...
        public SegmentableBody(World world, IEnumerable<Shape> shapes, Vector2 position = new Vector2(), float rotation = 0) : this(world)
        {
            MainBody = World.CreateBody(position, rotation, BodyType.Dynamic);
        ...
        public SegmentableBody(World world, Vertices vertices, float density, Vector2 position = new Vector2(), float rotation = 0) : this(world)
        {
            MainBody = World.CreateBody(position, rotation, BodyType.Dynamic);
